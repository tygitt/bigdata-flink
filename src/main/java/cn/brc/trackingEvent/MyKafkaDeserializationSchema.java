...
public class MyKafkaDeserializationSchema implements KafkaDeserializationSchema<TrackingEventBean> {

    private final Logger logger = LoggerFactory.getLogger(MyKafkaDeserializationSchema.class);
