...
public class MyKafkaSchema implements KafkaDeserializationSchema<TrackingEventBean> {

    private final Logger logger = LoggerFactory.getLogger(MyKafkaSchema.class);
    ...
    @Override
    public TrackingEventBean deserialize(ConsumerRecord<byte[], byte[]> consumerRecord) throws Exception {
        Gson gson = new Gson();
